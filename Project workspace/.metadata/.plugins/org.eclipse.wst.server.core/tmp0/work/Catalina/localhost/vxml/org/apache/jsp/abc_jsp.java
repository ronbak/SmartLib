...
String name=(String)session.getAttribute("name"); 
      out.write("\r\n");
      out.write("<prompt>hello<break time=\"small\"/> ");
      out.print(name );
      out.write(".<break time=\"small\"/>You have logged in successfully<break time=\"small\"/> </prompt>\r\n");
      out.write(" ");
Connection con=ConnectionUtil.openConnection();
 ...
 if(rs.next())
 {
	int i=rs.getInt(1); 
      ...
      out.write(" \r\n");
      out.write("<prompt> WARNING YOU HAVE ALREADY TAKEN TWO BOOKSS.</prompt>    \t  \r\n");
      out.write("<prompt>  YOU CAN CONTINUE THIS CALL,But you need to return books on your visit to library </prompt>  ");
    }
 ...
 ConnectionUtil.closeConnection(rs,st,con);
      ...
      out.write("</block>\r\n");
      out.write("<block>\r\n");
      out.write("<submit next=\"category.jsp\"/>\r\n");
      out.write("</block>\r\n");
      out.write("</form>\r\n");
      out.write("</vxml>");
    } catch (Throwable t) {
